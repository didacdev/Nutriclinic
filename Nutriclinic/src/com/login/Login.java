...
import com.bd.DatabaseCreation;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        silueta = new javax.swing.JLabel();
        ...
        silueta.setBackground(new java.awt.Color(0, 134, 190));
        silueta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/silueta.png"))); // NOI18N
        bg.add(silueta, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, -10, 300, 630));

        favicon.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        favicon.setText("Nutriclinic");
        ...
        loginBtn.setBackground(new java.awt.Color(0, 161, 190));

        loginBtnTxt.setBackground(new java.awt.Color(2, 198, 238));
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        ...
        try{
           ...
           DatabaseCreation.dbCreation(user, password);
           java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    Dashboard p1 = new Dashboard(user, password);
                    p1.setVisible(true);
                }
           });
        }
    ...
    private javax.swing.JLabel silueta;
